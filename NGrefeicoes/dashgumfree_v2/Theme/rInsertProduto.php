...
<?php 
    ...
    <div class="showback">
        ...
        <div class="btn-group btn-group-justified">
            <div class="btn-group">
                <button type="button" class="btn btn-theme" onclick="window.location='insert_produto.php'">Adicionar mais</button>
            </div>
            <div class="btn-group">
                <button type="button" class="btn btn-theme" onclick="window.location='listar_produtos.php'">Lista Produtos</button>
            </div>
            <div class="btn-group">
